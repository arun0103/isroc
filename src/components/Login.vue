                      ...
                      <form class="row g-3 needs-validation" novalidate="" @submit.prevent="login">
                        ...
                        <div class="col-12">
                          ...
                          <div class="input-group has-validation">
                            ...
                            <input type="text" name="email" class="form-control" id="email" required="" v-bind="email">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="password" name="password" class="form-control" id="password" required="" v-bind="password">
                        ...
                        <div class="col-12">
                          <div class="form-check">
                            ...
                            <a style="float:right"><router-link to="/reset">Forgot Password?</router-link></a>
                          </div>
                        </div>
                        <div class="col-12">
    ...
    setup() {
      ...
      const login = async () => {
          try {
              ...
              Swal.fire("Sorry","Unauthorized credentials","error")
              console.error(error);
          }
      };
